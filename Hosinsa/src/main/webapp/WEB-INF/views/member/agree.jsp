	...
	<div class="checkbox_group">
		<div class="checkbox">
			<input type="checkbox" id="check_all"> <label for="check_all">개인정보
				처리방침, 서비스 이용약관, 위치정보 이용약관,<br> 이벤트 등 프로모션 알림 메일 수신에 모두 동의합니다.
			</label>
		</div>
		<br>
		<div class="checkbox">
			<input type="checkbox" id="check_1" class="normal"> <label
				for="check_1">서비스 이용약관 동의 &nbsp;<span style="color: red;">(필수)</span></label>
			<div>
				<textarea rows="20" cols="100" readonly="readonly">제 1 장 총칙
		...
		<div class="checkbox">
			...
			<div>
				<textarea rows="20" cols="100">
  					1. 개인정보의 수집항목 및 수집방법 
HOSINSA 에서는 기본적인 회원 서비스 제공을 위한 필수정보로 실명인증정보와 가입정보로 구분하여 다음의 정보를 수집하고 있습니다. 필수정보를 입력해주셔야 회원 서비스 이용이 가능합니다.
...
$(document).ready(function(){
	...
	$("#agreeBtn").on("click", function() {
		...
		if (check1 == true && check2 == true) {
			...
			alert("HOSINSA 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.");
		}
	});
});
</script>
