...
<div class="contentWrap">
	<div class="array_center">
		<h2 class="title align_center">약관 동의</h2>
		<div class="checkbox_group">
			<div class="checkbox">
				<input type="checkbox" id="check_all"> <label
					for="check_all">개인정보 처리방침, 서비스 이용약관, 위치정보 이용약관,<br> 이벤트
					등 프로모션 알림 메일 수신에 모두 동의합니다.
				</label>
			</div>
			<br>
			<div class="checkbox">
				...
				<div>
					<textarea rows="20" cols="75" readonly="readonly">제 1 장 총칙
