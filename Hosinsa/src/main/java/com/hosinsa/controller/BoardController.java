...
public class BoardController {
	...
	public String eventList(BoardCriteria cri, Model model) {
	...
	public String eventRead(@RequestParam("event_no") Long event_no, @ModelAttribute("cri") BoardCriteria cri, Model model) {
	...
	public String eventModify(BoardEventVO bevo, BoardCriteria cri,  MultipartFile uploadFile, Model model) throws IOException{
		//==========================배포 전 경로 Works3로 수정해 주세요.
		String uploadFolder = "C:\\Works3\\Project-Hosinsa\\Hosinsa\\src\\main\\webapp\\resources\\images\\eventBanner\\";
		String fileName = uploadFile.getOriginalFilename();
	...
	public String eventRemove(@RequestParam("event_no") Long event_no, BoardCriteria cri, RedirectAttributes rttr) {
	...
	public String noticeRegister(BoardNoticeVO bnvo, BoardCriteria cri, Model model) {
	...
	public String noticeModify(BoardNoticeVO bnvo, BoardCriteria cri, Model model) {
	...
	public String noticeRemove(@RequestParam("nno") Long nno, BoardCriteria cri, RedirectAttributes rttr) {
