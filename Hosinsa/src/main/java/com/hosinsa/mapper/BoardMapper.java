...
public interface BoardMapper {
	public List<BoardEventVO> getListWithPagingEvent(BoardCriteria cri);    // 이벤트 리스트 출력
	...
	public int getTotalCountEvent(BoardCriteria cri);						// 이벤트 전체 개수
	...
	public List<BoardNoticeVO> getListWithPagingNotice(BoardCriteria cri);  // 공지사항 리스트 출력
	...
	public int getTotalCountNotice(BoardCriteria cri);						// 공지사항 전체 개수
